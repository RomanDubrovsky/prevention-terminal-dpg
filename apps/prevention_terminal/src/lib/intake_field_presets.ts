...
export const SCHOOL_CONTACTED_BY_PRESETS: IntakePresetOption[] = [
  { id: "student", label: t("Учащийся", "Student") },
  { id: "parent", label: t("Родитель", "Parent") },
  { id: "educator", label: t("Педагог", "Educator") },
  { id: CUSTOM_PRESET_ID, label: t("Свой вариант…", "Custom...") },
];
...
export const SCHOOL_CONCERN_FOR_PRESETS: IntakePresetOption[] = [
  { id: "student", label: t("Учащийся", "Student") },
  { id: "parent", label: t("Родитель", "Parent") },
  { id: "educator", label: t("Педагог", "Educator") },
  { id: CUSTOM_PRESET_ID, label: t("Свой вариант…", "Custom...") },
...
export const SCHOOL_INITIATIVE_PRESETS: IntakePresetOption[] = [
  { id: "student", label: t("Учащийся", "Student") },
  { id: "parent", label: t("Родитель", "Parent") },
  { id: "educator", label: t("Педагог", "Educator") },
  { id: "school_admin", label: t("Администрация школы / ПМПк / КДН", "School administration / PMPk / KDN") },
  { id: CUSTOM_PRESET_ID, label: t("Свой вариант…", "Custom...") },
];

export function contactedByPresetsForOrg(commercial: boolean): IntakePresetOption[] {
  return commercial ? CONTACTED_BY_PRESETS : SCHOOL_CONTACTED_BY_PRESETS;
}

export function concernForPresetsForOrg(commercial: boolean): IntakePresetOption[] {
  return commercial ? CONCERN_FOR_PRESETS : SCHOOL_CONCERN_FOR_PRESETS;
}

export function initiativePresetsForOrg(commercial: boolean): IntakePresetOption[] {
  return commercial ? INITIATIVE_PRESETS : SCHOOL_INITIATIVE_PRESETS;
}
