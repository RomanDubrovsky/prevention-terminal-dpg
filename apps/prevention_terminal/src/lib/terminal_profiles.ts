...
import {
  ...
  COMMERCIAL_ORG_TYPE_VALUES,
  COMMERCIAL_ORG_TYPE_LABEL,
  type EducationOrgType,
  type OrgSphere,
  type YouthOrgType,
  type CommercialOrgType,
} from "./org_sphere.ts";

export type { EducationOrgType, OrgSphere, YouthOrgType, CommercialOrgType } from "./org_sphere.ts";
export {
...
export const DEFAULT_ORG_PROFILE: OrgProfileInput = {
  ...
  org_sphere_other: "",
  education_org_type: "general_school",
