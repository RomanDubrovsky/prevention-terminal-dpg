...
describe("site pages", () => {
  ...
  it("builds default page URLs", () => {
    ...
    assert.equal(urls.consult, "https://irpp-edu.ru/specialists");
    assert.equal(urls.chat, "https://irpp-edu.ru/chat");
    assert.equal(urls.register, "https://irpp-edu.ru/staff-register");
  ...
  it("consult booking from plan", () => {
    ...
    assert.equal(url, "https://center.ru/specialists");
  });
