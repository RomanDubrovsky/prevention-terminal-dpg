...
function buildAuthorityDemoRollup(): ManagerRollup {
  return {
    ...
    metrics: {
      ...
      top_learning_opportunities: "Кризисная интервенция, Медиация конфликтов",
    },
    territories: [
      ...
      },
      {
        ...
        suppressed: false,
        k_floor: 3,
        metrics: { consultation_count: 18, group_session_count: 3, active_cases: 7, ipr_count: 2, work_minutes: 1080, new_cases_in_period: 4, case_count: 8, reception_entries: 10 },
      },
      {
        key: "school_boarding7",
