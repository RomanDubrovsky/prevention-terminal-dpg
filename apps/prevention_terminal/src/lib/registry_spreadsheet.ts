...
export function registrySubjectsToCsv(subjects: RegistrySubjectSummary[]): string {
  const lines = [
    "sep=;",
    REGISTRY_SPREADSHEET_HEADERS.map(csvCell).join(";"),
  ];
...
export function downloadRegistryTemplateSpreadsheet(
  isCommercial = false,
  filename = "obrazets-tablicy-reestra.csv",
): void {
  const lines = [
    "sep=;",
    REGISTRY_SPREADSHEET_HEADERS.map(csvCell).join(";"),
  ...
  const demoRows = isCommercial
    ? [
        ["Иванов Иван Алексеевич", "Мужской", "34", "", "1990-05-12", "+7 900 123-45-67", "ivanov@example.com", "г. Москва, ул. Ленина, д. 5", "Иванова Ольга (супруга)", "Первичная консультация, тревожность"],
        ["Смирнова Анна Дмитриевна", "Женский", "28", "", "1996-08-20", "+7 900 234-56-78", "smirnova@example.com", "г. Москва, пр. Мира, д. 12", "", "Запрос на коучинг и выгорание"],
        ["Козлов Михаил Сергеевич", "Мужской", "42", "", "1982-11-04", "+7 900 345-67-89", "kozlov@example.com", "г. Москва, ул. Тверская, д. 8", "Козлова Наталья (супруга)", "Семейная медиация"],
      ]
    : [
        ["Иванов Иван Алексеевич", "Мужской", "14", "8Б", "2010-04-12", "+7 900 123-45-67", "ivanov@school.ru", "г. Москва, ул. Школьная, д. 10", "Иванова Елена Сергеевна (мать)", "Староста класса, участие в олимпиадах"],
        ["Смирнова Анна Дмитриевна", "Женский", "14", "8Б", "2010-09-18", "+7 900 234-56-78", "smirnova@school.ru", "г. Москва, ул. Лесная, д. 4", "Смирнов Дмитрий Петрович (отец)", "Запрос на профориентацию"],
        ["Козлов Михаил Сергеевич", "Мужской", "12", "6А", "2012-02-25", "+7 900 345-67-89", "kozlov@school.ru", "г. Москва, пр. Мира, д. 15", "Козлова Ольга Ивановна (мать)", "Трудности адаптации в новом коллективе"],
        ["Васильева Дарья Павловна", "Женский", "17", "11А", "2007-06-30", "+7 900 456-78-90", "vasilieva@school.ru", "г. Москва, ул. Победы, д. 22", "Васильев Павел Николаевич (отец)", "Подготовка к экзаменам, стресс"],
        ["Соколов Артем Романович", "Мужской", "7", "1В", "2017-03-14", "+7 900 567-89-01", "sokolov@school.ru", "г. Москва, ул. Садовая, д. 3", "Соколова Наталья Андреевна (мать)", "Первый класс, диагностика готовности"],
      ];
