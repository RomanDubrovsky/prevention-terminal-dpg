...
export type ManagerWorkspaceView = "dashboard" | "leads" | "specialists" | "users" | "ai_consultant" | "academy" | "feedback" | "settings";
...
export function buildManagerNav(
  ...
  if (cfg ? isTerminalModuleEnabled(cfg, "academy") : true) {
    items.push({ id: "academy", label: t('Академия', 'Academy'), icon: "academy", group: "system", aiCluster: true });
  }
