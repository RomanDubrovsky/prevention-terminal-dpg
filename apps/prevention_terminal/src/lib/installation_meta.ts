...
export const ORGANIZATION_TYPE_LABEL: Record<OrganizationType, string> = {
  school: "Общеобразовательная школа (школа, гимназия, лицей)",
  ...
  correctional: "Коррекционная школа / интернат",
  supplementary: "Дополнительное образование",
  camp_vacation: "Организация отдыха и оздоровления детей (лагерь)",
  youth_center: "Молодёжный центр / учреждение",
  private_practice: "Частная практика / кабинет",
