...
export function buildSchoolDemoStore(workspace: DemoWorkspace, edition: string): StagingStore {
  ...
  const isEducator = workspace === "educator";
  const isManager = (workspace === "manager" || workspace === "school_manager" || isAuthority) && !isEducator;
  const isIntl = edition === "intl";

  const modules = isEducator
    ? defaultEnabledModules("specialist", "education", "educator_lite")
  ...
  return {
    ...
    specialistProfile: {
      display_name: isIntl
        ? isAuthority ? "Dr. Alexander Vance" : isManager ? "Dr. Helen Smith" : isEducator ? "Sarah Connor" : "David Martinez"
        : isAuthority ? "Воронцов Александр Сергеевич" : isManager ? "Смирнова Елена Николаевна" : isEducator ? "Иванова Ольга Сергеевна" : "Морозов Дмитрий Иванович",
      role_text: isIntl
        ? isAuthority ? "Head of Education Authority" : isManager ? "Principal" : isEducator ? "Classroom Teacher (8B)" : "School Psychologist"
        : isAuthority ? "Начальник Управления образования" : isManager ? "Директор" : isEducator ? "Классный руководитель (8Б)" : "Педагог-психолог",
    ...
    terminalConfig: {
      ...
      workspace_preset: isManager ? "manager" : isEducator ? "educator_lite" : "specialist",
      ...
      registry_enabled: !isManager && !isEducator,
      ...
      registry_vault_initialized: !isManager && !isEducator,
      registry_recovery_key_hash: (isManager || isEducator) ? null : "demo-registry-vault-hash",
    ...
    cases: [
      // --- Реестр: ученики ---
      {
        ...
        case_artifacts_json: JSON.stringify({
          ...
          situation_title: isIntl ? "Alice Johnson (8th Grade)" : "Алиса Денисова (8 класс)",
          registry_profile: {
            full_name: isIntl ? "Alice Johnson" : "Алиса Денисова",
            gender: "female",
            age_years: 14,
            grade_class: "8Б",
            ...
            email: "",
            address: "",
            contact_person: isIntl ? "Sarah J. (Mother)" : "Светлана Д. (Мама)",
            notes: isIntl
      ...
      },
      {
        ...
        case_artifacts_json: JSON.stringify({
          record_kind: "registry_subject",
          situation_title: isIntl ? "Bob Miller (8th Grade)" : "Богдан Мельников (8 класс)",
          registry_profile: {
            full_name: isIntl ? "Bob Miller" : "Богдан Мельников",
            gender: "male",
            age_years: 14,
            grade_class: "8Б",
      ...
      },
      {
        ...
        case_artifacts_json: JSON.stringify({
          record_kind: "registry_subject",
          situation_title: isIntl ? "Michael Chen (11th Grade)" : "Михаил Чернов (11 класс)",
          registry_profile: {
            full_name: isIntl ? "Michael Chen" : "Михаил Чернов",
            gender: "male",
            age_years: 17,
            grade_class: "11А",
      ...
      // --- Кейсы (ситуации) ---
      {
        ...
        case_artifacts_json: JSON.stringify({
          ...
          situation_title: isIntl ? "8B Cyberbullying (Alice & Bob)" : "8Б — Кибербуллинг (Алиса и Богдан)",
          ...
          primary_description: isIntl
            ...
            : "Алису травят в групповом чате, созданном Богданом. Оскорбительные сообщения, фотографии без согласия. Подключены классный руководитель и родители.",
            ...
            "alias-demo-s2": {
              fba: {
                text: isIntl
                  ...
                  : "Анализ поведения Богдана М. (ФАП): агрессивное поведение в чате выполняет функцию привлечения внимания сверстников и утверждения социального доминирования. Функциональный аналог — поиск признания.",
                saved_at: daysAgoIso(4),
              },
              bip: {
                text: isIntl
                  ? "BIP: Teach prosocial leader strategies. Behavioral contract with class teacher."
                  : "План поведенческого вмешательства (BIP): Обучение Богдана альтернативным просоциальным способам лидерства, введение поведенческого контракта с классным руководителем. Контроль еженедельно.",
                saved_at: daysAgoIso(4),
              },
              mdr: {
                text: isIntl
      ...
      },
      {
        ...
        case_artifacts_json: JSON.stringify({
          ...
          situation_title: isIntl ? "Michael - Exam Anxiety" : "Михаил — Экзаменационная тревога",
    ...
    caseAliases: [
      ...
      { case_id: caseBullying, alias_id: "alias-demo-s2", role: "aggressor", role_no: 1, real_name: isIntl ? "Bob M."     : "Богдан М." },
      { case_id: caseExam,     alias_id: "alias-demo-s3", role: "client",    role_no: 1, real_name: isIntl ? "Michael C." : "Михаил Ч." },
    ...
    workLog: [
      {
        ...
        note: consultationNote({
          goal: isIntl ? "Mediation meeting between Alice and Bob, setting ground rules" : "Медиативная встреча Алисы и Богдана, установка правил",
          observations: isIntl ? "Bob was defensive, Alice was withdrawn. Tense verbal atmosphere." : "Богдан защищался, Алиса была замкнута. Тон агрессивный.",
          ...
          assessment: isIntl ? "Bob agreed to delete the group chat. Tense but productive session." : "Богдан согласился удалить чат. Напряженно, но продуктивно.",
      ...
      },
      {
        ...
        note: consultationNote({
          ...
          assessment: isIntl ? "Michael successfully applied grounding in session. Anxiety decreased from 8/10 to 5/10." : "Михаил успешно применил заземление на сессии. Уровень тревоги снизился с 8/10 до 5/10.",
      ...
      },
      {
        ...
        note: consultationNote({
          goal: isIntl ? "Work with Bob — developing empathy" : "Работа с Богданом — развитие эмпатии",
      ...
      },
      {
        ...
        note: consultationNote({
          ...
          observations: isIntl ? "Michael reports feeling better. Anxiety scale 4/10. Sleeping normally." : "Михаил говорит, что стало лучше. Шкала тревоги 4/10. Спит нормально.",
    ...
    groupSessions: [
      {
        ...
        report_text: isIntl
          ...
          : "Высокая вовлечённость. Несколько учеников поделились личным опытом. Богдан М. участвовал — заметна рефлексия. Запрошена повторная сессия классным руководителем.",
      ...
      },
      {
        ...
        report_text: isIntl
          ...
          : "Михаил Ч. участвовал — заметно открылся группе. 10 из 12 снизили самооценку тревоги за сессию. Группа сплачивается.",
    ...
    workEntries: [
      ...
      { entry_id: "we-sch-7", date: dateDaysAgo(1),  category: "consultation", minutes: 45,  note: isIntl ? "Final session Michael C." : "Итоговая сессия Михаил Ч." },
    ],
    ...
    iprs: [
      ...
      },
      {
        id: "ipr-demo-sch-02",
        case_id: caseExam,
        title: isIntl ? "IPR — Michael C. (reducing exam anxiety)" : "ИПР — Михаил Ч. (снижение экзаменационной тревоги)",
        description: isIntl
    ...
    iprSteps: [
      ...
      // ИПР Майкла
      {
        ...
        target_date: daysAgoIso(7),
        status: "done",
        notes: isIntl ? "Completed. Michael mastered the technique and applies it independently." : "Завершено. Михаил освоил технику и применяет самостоятельно.",
        created_at: daysAgoIso(20),
