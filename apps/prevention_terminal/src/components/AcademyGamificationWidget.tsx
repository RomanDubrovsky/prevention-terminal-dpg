              ...
              <div>
                ...
                <div id="print-certificate-area" style={{
                  ...
                  <p style={{ maxWidth: "550px", margin: "0 auto 30px auto", fontSize: "0.9rem", color: "#475569", lineHeight: "1.5" }}>
                    ...
                    <em>mhGAP Первичный скрининг • Мотивационное интервью (OARS) • Регуляция острого аффекта (DBT) • Когнитивная реструктуризация (КПТ) • Семейные системные интервенции (ОРКТ)</em>.
                  </p>
