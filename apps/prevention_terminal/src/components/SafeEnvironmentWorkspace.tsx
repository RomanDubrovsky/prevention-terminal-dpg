...
Запланированные действия: ${JSON.stringify(draft.actions || [])}`;
  ...
  return (
    <div className="workspace-panel-stack safe-environment-workspace">
      ...
      {editorOpen && (
        <section className="card group-session-editor" style={{ display: 'flex', gap: '24px', flexDirection: 'row', alignItems: 'flex-start' }}>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px', minWidth: 0 }}>
            <div className="group-session-editor-head" style={{ marginBottom: 0 }}>
            ...
            <div className="group-session-form" style={{ display: "flex", gap: "16px" }}>
            ...
            <div style={{ background: '#f8fafc', padding: '16px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
              <h3 style={{ margin: "0 0 12px 0", fontSize: "1.1rem", color: 'var(--violet)' }}>Шаг 1. Запланируйте мероприятия</h3>
              <p className="muted tiny" style={{ marginBottom: "16px", marginTop: "-8px" }}>
                Добавьте конкретные профилактические мероприятия. ИИ будет опираться на них при генерации плана и отчета.
              </p>
                      ...
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.95rem" }}>
                        <thead>
                          <tr style={{ borderBottom: "1px solid var(--line)" }}>
                            <th style={{ textAlign: "left", padding: "6px" }}>Действие / Метод *</th>
                            <th style={{ textAlign: "left", padding: "6px", width: "110px" }}>План</th>
                            <th style={{ textAlign: "left", padding: "6px", width: "110px" }}>Факт</th>
                            <th style={{ textAlign: "left", padding: "6px", width: "120px" }}>Исполнитель</th>
                            <th style={{ textAlign: "left", padding: "6px" }}>Пояснения</th>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              <h3 style={{ margin: "0", fontSize: "1.1rem", color: "var(--violet)" }}>Шаг 3. Ручная проверка текста</h3>
              <p className="muted tiny" style={{ marginTop: "-20px", marginBottom: "0" }}>
                Проверьте сгенерированные тексты плана, экспертизы и отчета.
              </p>
              
              <div className="summary-split-block wide" style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "10px" }}>
                  <label className="field wide">
                    <span style={{ fontWeight: '600', color: '#333' }}>Результаты экспертизы и методические рекомендации</span>
                    <textarea
                      rows={10}
                      value={draft.notes || ""}
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "10px" }}>
                  <label className="field wide">
                    <span style={{ fontWeight: '600', color: '#333' }}>Содержание плана программы (Текст)</span>
                    <textarea
                      rows={10}
              ...
              <div className="group-session-form">
                <label className="field wide">
                  <span style={{ fontWeight: '600', color: '#333' }}>Отчёт о реализации программы (Текст)</span>
                  <textarea
                    rows={10}
          ...
          <div style={{ width: '360px', flexShrink: 0, display: 'flex', flexDirection: 'column', gap: '16px', position: 'sticky', top: '20px' }}>
            <section className="card" style={{ background: 'linear-gradient(135deg, rgba(124, 58, 237, 0.04), rgba(139, 92, 246, 0.01))', border: '1px solid rgba(124, 58, 237, 0.2)', borderRadius: '12px', padding: '20px' }}>
              ...
              <p className="muted tiny" style={{ marginBottom: '16px', lineHeight: '1.5' }}>
                ИИ изучит ваши мероприятия из Шага 1 и сам напишет профессиональный черновик для каждого из разделов, либо проведет экспертизу документа.
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '16px' }}>
                <DocumentSmartChat
                  ...
                  showPlanButton={true}
                  planButtonLabel="Сгенерировать план"
                  showReportButton={true}
                  reportButtonLabel="Сгенерировать отчет"
                  showExpertiseButton={true}
                  expertiseButtonLabel="Провести экспертизу"
