        ...
        {commercial && primaryOnly ? (
          <>
            ...
            <ParticipantMarkerSelect
              ...
              hint={commercial ? t("Роль и маркер участника: клиент, партнёр, родитель…", "Role and participant marker: client, partner, parent...") : t("Учащийся, родитель или педагог…", "Student, parent or educator...")}
            ...
            <PresetSelectWithCustom
              ...
              hint={commercial ? t("Сам клиент, родственник, организация, направление…", "Client themselves, relative, organization, referral...") : t("Сам учащийся, родитель, педагог, администрация…", "Student, parent, educator, school admin...")}
