...
export default function ConsultationJournalPanel(props: ConsultationJournalPanelProps) {
  ...
  const step3Filled = Boolean(draft.observations.trim()) || Boolean(draft.intervention.trim()) || hasSessionTagSelection(sessionTags.formats) || hasSessionTagSelection(sessionTags.methods);
