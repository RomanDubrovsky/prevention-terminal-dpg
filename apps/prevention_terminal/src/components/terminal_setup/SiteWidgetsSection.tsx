        ...
        <div style={{ padding: "14px 18px", background: "#f8fafc", border: "1px solid var(--line)", borderRadius: "12px", margin: "12px 0 24px 0", fontSize: "0.85rem", lineHeight: "1.5" }}>
          ...
          <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", alignItems: "center" }}>
            <div>
              ...
              <code style={{ background: "#e2e8f0", padding: "3px 8px", borderRadius: "6px", fontWeight: 700, userSelect: "all" }}>{portal.center_id}</code>
            </div>
            <div>
              <span className="muted tiny">Ключ подключения (Token): </span>
              <code style={{ background: "#e2e8f0", padding: "3px 8px", borderRadius: "6px", fontWeight: 700, userSelect: "all" }}>{portal.setup_token}</code>
            </div>
          </div>
        </div>
      )}
