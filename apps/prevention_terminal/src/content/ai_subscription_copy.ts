...
export const AI_SUBSCRIPTION_LEGAL = {
  ...
  checkoutNote:
    "Оплата проходит на защищённой странице ИРПП (Tilda). Разовый платёж, без автоматических списаний.",
  activationHint:
    "После оплаты укажите на странице ИРПП тот же email и ID терминала (ниже). Активация обычно в течение нескольких минут.",
  operator: "Оператор витрины и оплаты — ООО «ИРПП».",
} as const;

export const AI_SUBSCRIPTION_LINKS = {
  terms: "https://irpp-edu.ru/",
  privacy: "https://irpp-edu.ru/",
  hub: "https://irpp-edu.ru/profilaktika-ai/",
  checkoutRu: "https://irpp-edu.ru/profilaktika-ai/oplata/",
} as const;
