  ...
  var I18N = {
    en: {
      ...
      quota: function (left, limit) {
        return (
          "Free: " + left + " of " + limit + " messages today. " +
          "Full DOCX export & unlimited chat — in Prevention Terminal."
        );
      },
      dailyLimit: "Daily limit reached. Download Prevention Terminal for unlimited access.",
    ...
    ru: {
      ...
      quota: function (left, limit) {
        return (
          "Бесплатно: " + left + " из " + limit + " сообщений на сегодня. " +
          "Выгрузка DOCX и чат без лимитов — в Prevention Terminal."
        );
      },
      dailyLimit:
        "Дневной лимит исчерпан. Скачайте Prevention Terminal — там без ограничений.",
