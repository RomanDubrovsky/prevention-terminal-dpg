...
(function () {
  ...
  function appendMsg(text, who, isPlan) {
    ...
    shareBtn.innerHTML = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg><span>' + t.shareMsg + '</span>';
    shareBtn.addEventListener("click", function (e) {
      e.stopPropagation();
      shareData(who === "ai" ? t.aiRole : t.userRole, text);
    });
